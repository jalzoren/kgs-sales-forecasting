...
const API = import.meta.env.VITE_API_URL.replace(/\/+$/, ""); // removes trailing slash
const LOGIN_API = `${API}/login`; // becomes https://kgs-sales-forecasting.onrender.com/api/login
